...
# Core API utilities provided by the Maven project
...
def service_api(msg: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if op == "LEARN_FROM_RUN":
        ...
        append_jsonl(t["stm"], {"ts": time.time(), "op":"AGG_UPDATE", "aggregate_total_runs": agg.get("total_runs",0)})
    ...
    if op == "ADAPT_WEIGHTS_SUGGEST":
        ...
        t = ensure_dirs(BRAIN_ROOT)
        append_jsonl(t["stm"], {"ts": time.time(), "op": "ADAPT_SUGGEST", "suggestion": suggestion})
