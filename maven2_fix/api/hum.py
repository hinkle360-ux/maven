...
# The HUM state file lives under reports/system.  It's defined relative
# to the api directory: api/.. -> maven root -> reports/system
STATE_PATH = Path(__file__).resolve().parents[2] / "reports" / "system" / "hum_state.json"
