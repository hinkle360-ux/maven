...
# Determine the project root.  This file lives in
# project/maven_project/project/brains/personal/service, so three parents
# up is the root of the Maven project.  The reports directory resides
# under this root.
PROJECT_ROOT = Path(__file__).resolve().parents[3]

# Path to the persistent identity file.  Stored under reports/personal.
IDENTITY_FILE = PROJECT_ROOT / "reports" / "personal" / "identity.json"
