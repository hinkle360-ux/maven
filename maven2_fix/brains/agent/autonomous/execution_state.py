...
class ExecutionState:
    ...
    def __init__(self) -> None:
        ...
        # project root.  We ascend four parents from this file to
        # reach the ``maven_update`` directory.
        base = Path(__file__).resolve()
        try:
            project_root = base.parents[4]
        except Exception:
            project_root = base
        self.checkpoint_dir: Path = project_root / "reports" / "agent" / "checkpoints"
