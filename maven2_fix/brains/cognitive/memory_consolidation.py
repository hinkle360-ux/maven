...
def consolidate_memories() -> None:
    ...
    """
    # Determine the maven project root.  The code lives under
    # ``maven/brains/cognitive``.  ``__file__.resolve().parents[2]``
    # corresponds to the maven root (parents[0] = cognitive,
    # parents[1] = brains, parents[2] = maven).
    root = Path(__file__).resolve().parents[2]
    cognitive_dir = root / "brains" / "cognitive"
